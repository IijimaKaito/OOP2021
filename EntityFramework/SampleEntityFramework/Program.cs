    ...
    class Program
    {
        ...
        private static void Exercise13_1_1()
        {
            using (var db = new BooksDbContext())
            {
                ...
                var author = db.Authors.Single(a => a.Name == "夏目漱石");
                var book1 = new Book
                {
                    Title = "こころ",
                    PublishedYear = 1991,
                ...
                db.Books.Add(book1);
                var author3 = db.Authors.Single(a => a.Name == "川端康成");
                var book2 = new Book
                {
                    Title = "伊豆の踊子",
                    PublishedYear = 2003,
                ...
                db.Books.Add(book2);
                var author4 = db.Authors.Single(a => a.Name == "菊池寛");
                var book3 = new Book
                {
                    Title = "真珠婦人",
                    PublishedYear = 2002,
                ...
                db.Books.Add(book3);
                var author5= db.Authors.Single(a => a.Name == "宮沢賢治");
                var book4= new Book
                {
                    Title = "注文の多い料理店",
                    PublishedYear = 2000,
